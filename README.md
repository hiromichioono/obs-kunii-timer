...
├── timer_input.html          # タイマー操作パネル（PC モニターのブラウザで開く）
...
| 個人コメント数マイルストーン | 3・11（サッカー特別数）・5刻み・10刻みなどの節目で `🏆 {名前}さん、{N}コメ達成！` | `chat_overlay.html` |
| 配信全体コメント数マイルストーン | 10 件ごと（50 件以降は 50 刻み、200 件以降は 100 刻み）で `🎉 配信コメント{N}件突破！` | `ticker_overlay.html` |
